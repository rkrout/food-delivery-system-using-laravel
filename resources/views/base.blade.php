...
<body>    
    <nav class="bg-white h-20 shadow-md fixed left-0 right-0 top-0 z-9">
        <div class="max-w-5xl mx-auto h-full flex justify-between items-center">
            ...
            <a href="{{ route('home') }}" class="text-2xl text-orange-600 font-bold">
            ...
            <ul class="flex gap-8">
                <li>
                    <a 
                        class="flex gap-1 items-center text-orange-600 cursor-pointer transition-all duration-300" 
                        href="{{ route('home') }}"
                    >
                ...
                <li>
                    <a 
                        class="flex gap-1 items-center hover:text-orange-600 cursor-pointer transition-all duration-300" 
                        href="{{ route('search') }}"
                    >
                ...
                <li class="relative">
                    ...
                    <ul id="menu" class="absolute z-50 bg-white shadow-md w-48 py-2 rounded-md right-0 top-10 overflow-hidden hidden">
                        <li>
                            <a 
    ...
    <div class="mt-20 overflow-auto" style="height: calc(100vh - 80px)">
        @yield('content')
    </div>
    ...
    <script>
        ...
        document.querySelector("#dropDownBtn").onclick = event => {
