...
@section('content') 
    ...
    <h2 class="text-2xl font-bold text-orange-600 mt-8 mb-5 text-center">Our Delicious Food</h2>


    <div class="grid grid-cols-1 md:grid-cols-2 px-3 lg:px-0 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
